...
print("BISECT: after tail-call varargs")
...
print("BISECT: after C-stack overflow")
...
print("BISECT: after __call chain coroutine")
...
print("BISECT: after testing chains")

a = nil
(function (x) a=x end)(23)
assert(a == 23 and (function (x) return x*2 end)(20) == 40)

print("BISECT: after a=23")
...
print("BISECT: after incorrect args")

-- Now do the load reader test
...
print("BISECT: about to load")
local a = assert(load(read1(x), "modname", "t", _G))
print("BISECT: loaded successfully")
assert(a() == "\0" and _G.x == 33)
print("BISECT: ran loaded function ok")
