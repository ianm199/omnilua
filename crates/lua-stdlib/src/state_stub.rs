...
pub trait LuaStateStubExt {
    ...
    fn protected_call(&mut self, nargs: i32, nresults: i32, msgh: i32) -> Result<(), LuaError> {
        todo!("phase-b-reconcile: protected_call")
    }
    fn protected_call_k(
        &mut self,
        nargs: i32,
    ...
    fn set_warn_fn(
        ...
        todo!("phase-b-reconcile: set_warn_fn")
    }
    ...
    fn set_funcs_with_upvalues<F: Copy>(
        ...
        todo!("phase-b-reconcile: set_funcs_with_upvalues")
    }
    ...
    fn lua_traceback(
        ...
        todo!("phase-b-reconcile: lua_traceback")
    }

    fn get_hook_count(&mut self) -> i32 {
        todo!("phase-b-reconcile: get_hook_count")
    }
    fn get_hook_mask(&mut self) -> u32 {
        todo!("phase-b-reconcile: get_hook_mask")
    }
    fn hook_is_set(&mut self) -> bool {
        todo!("phase-b-reconcile: hook_is_set")
    }
    fn hook_is_internal_lua_hook(&mut self) -> bool {
        todo!("phase-b-reconcile: hook_is_internal_lua_hook")
    }
    fn set_c_stack_limit(&mut self, limit: i32) -> Result<i32, LuaError> {
        todo!("phase-b-reconcile: set_c_stack_limit")
    }
    ...
    fn is_same_thread(&mut self, other: &LuaState) -> bool {
        todo!("phase-b-reconcile: is_same_thread")
    }
    fn thread_status(&mut self) -> LuaStatus {
        todo!("phase-b-reconcile: thread_status")
    }
...
impl LuaStateStubExt for LuaState {
        ...
        match lua_vm::api::to_integer_x(self, arg) {
            ...
            None => {
                if lua_vm::api::is_number(self, arg) {
                    ...
                    Err(lua_vm::debug::arg_error_impl(
                        self,
                        arg,
                        extramsg.as_bytes(),
                    ))
    ...
    fn gc_control_simple(&mut self, op: i32) -> Result<i32, LuaError> {
        let args = match op {
            ...
            _ => return Err(LuaError::runtime(format_args!("invalid GC option {}", op))),
        };
